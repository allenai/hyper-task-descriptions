...
from hyper_task_descriptions.common.testing import HyperTaskDescriptionsTestCase
...
class TestHyperEncoderDecoderModel(parameterized.TestCase):
    ...
    #         def encode(self):
    #             # TODO: confirm
    #             return jnp.zeros((batch_size, encoder_len + hyper_encoder_len, emb_dim))
    #
    #         def decode(self):
    #             return (dummy_logits, {"cache": {}})
    #
    ...
    #         model = HyperEncoderDecoderModel()
    #
    #     # TODO: apparently, the module needs to be hyper_network.
